  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 px-4 py-8 text-gray-900">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute left-[15%] top-[30%] h-2 w-2 animate-bounce rounded-full bg-indigo-400/50" />

        <div
          className="absolute right-[18%] top-[25%] h-2 w-2 animate-bounce rounded-full bg-violet-400/50"
      ...
      <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 via-violet-600 to-cyan-500 text-2xl text-white shadow-xl shadow-indigo-200 transition-all duration-500 hover:rotate-6 hover:scale-110 hover:shadow-2xl hover:shadow-indigo-300">
              ✦
            </div>
            ...
            <div className="relative">
              ...
              <div className="mb-7">
                ...
                <p className="mt-1.5 text-sm text-gray-500">
                  Join the support platform and start creating tickets.
                </p>
              </div>
